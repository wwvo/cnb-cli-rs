...
## 原始 Swagger
https://api.cnb.cool/#/operations/GetGroupSubRepos
...
| filter_type | 字符串 | 否| Repositories type|
...
| desc | 布尔值 | 否| Ordering|
| descendant | 字符串 | 否| 查全部/查询直接属于当前组织的仓库/查询子组织的仓库。Get all/Get repos belong to current org or sub-organization|
| search | 字符串 | 否| Key word|
## 响应信息
