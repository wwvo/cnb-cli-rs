...
## 原始 Swagger
https://api.cnb.cool/#/operations/ListMemberAccessLevelOfRepo
...
**请求地址：** ${CNB_API_ENDPOINT}/{repo}/-/members/{username}/access-level
...
```bash
curl -X GET \
  "${CNB_API_ENDPOINT}/{repo}/-/members/{username}/access-level" \
