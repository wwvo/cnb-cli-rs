...
## 原始 Swagger
https://api.cnb.cool/#/operations/ListOutsideCollaborators
...
**请求地址：** ${CNB_API_ENDPOINT}/{slug}/-/outside-collaborators
...
**响应类型：** 数组[dto.OutsideCollaboratorInRepo]
...
```bash
curl -X GET \
  "${CNB_API_ENDPOINT}/{slug}/-/outside-collaborators" \
